...
const dict = {
  ...
  historyTitle: { ru: "Прошлые игры", en: "Past games" },
  historyDelete: { ru: "Удалить из истории", en: "Delete from history" },
  historyDeleteConfirm: {
    ru: "Удалить «{title}» из истории? Отменить это будет нельзя.",
    en: "Delete “{title}” from history? This can't be undone.",
  },
  historyOpenError: {
    ru: "Не удалось открыть это прохождение.",
    en: "Couldn't open this playthrough.",
  },
  ...
  galleryShownRange: { ru: "Показано {from}–{to} из {i}", en: "Showing {from}–{to} of {i}" },
  galleryPrev: { ru: "← Назад", en: "← Back" },
  galleryNext: { ru: "Вперёд →", en: "Next →" },
  ...
  downloadBrokenTitle: { ru: "Что-то не так с файлом?", en: "Something wrong with the file?" },
  downloadBrokenBody: {
    ru: "Запустите ускоренный рендер (экспериментально, может не сработать) или запустите просмотр видео заново — к его концу будет новый файл.",
    en: "Run a quick render (experimental, may not work) or replay the video — a fresh file will be ready by the end.",
  },
  downloadBrokenCancel: { ru: "Смотреть заново", en: "Watch again" },
  downloadBrokenMobileBody: {
    ru: "К сожалению, на телефоне сборка готового дубляжа идёт во время просмотра видео. Чтобы пересобрать файл, просмотрите свой дубляж заново.",
    en: "On phones, the dub is built while you watch — to rebuild it, replay your dub from the start.",
  },
